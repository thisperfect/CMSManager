...
public class DateUtil {
	...
	public final static String FORMAT_YEAR_MON_DAY_ZH = "yyyy年MM月dd日";
	...
	/**
	 * 检查接口请求是否过期
	 * @param requestTime 请求接口时候的时间戳
	 * @return 过期返回true
	 */
	public static boolean interval(Long requestTime){
		Long timeDifference = (System.currentTimeMillis() - requestTime) / (1000*60);
		return (timeDifference != null && timeDifference > 2);
	}
