...
<section id="page">
    ...
    <section id="login" class="visible">
        <div class="content-box-plain login-box">
            <h3 class="text-center"><img src="${basePath}/static/images/logo/logo.png" alt="logo"></h3>
...
<script type="text/javascript">
    $(function () {
        ...
        $("#btnSignIn").click(function () {
            ...
            $.ajax({
                type: "POST",
                url: "${basePath}/system/login.shtml",
        ...
        $("#btnRegister").click(function () {
            ...
            $.ajax({
                type: "POST",
                url: "${basePath }/system/register.shtml",
                ...
                success: function (data) {
                    if (data.code === '10000') {
                        location.replace('${basePath }/system/sendSuccess.shtml?email=' + _email);
                    } else {
                        if (data.code === '20004') {
    ...
    function createValidationCode(id, clas) {
        if ($("#" + id).find("img.pull-right").length > 0) {
